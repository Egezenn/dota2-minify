...
dota2_tools_executable = os.path.join(steam_dir, "steamapps\\common\\dota 2 beta\\game\\bin\\win64\\dota2cfg.exe")
...
def recalculate_paths(path):
    global steam_dir
    global minify_dota_compile_input_path
    global minify_dota_compile_output_path
    global minify_dota_pak_output_path
    global minify_dota_maps_output_path
    global minify_dota_content_path
    global dota2_executable
    global dota2_tools_executable
    global dota_core_pak01_path
    global dota_pak01_path
    global dota_itembuilds_path
    global dota_map_path
    global dota_resource_compiler_path

    ## minify
    steam_dir = path
    ### resourcecompiler required dir
    minify_dota_compile_input_path = os.path.join(path, "steamapps\\common\\dota 2 beta\\content\\dota_addons\\minify")
    ### compiled files from resourcefiles
    minify_dota_compile_output_path = os.path.join(path, "steamapps\\common\\dota 2 beta\\game\\dota_addons\\minify")
    ### vpk destination
    minify_dota_pak_output_path = os.path.join(path, "steamapps\\common\\dota 2 beta\\game\\dota_minify")
    minify_dota_maps_output_path = os.path.join(minify_dota_pak_output_path, "maps")
    # required for tools to launch
    minify_dota_content_path = os.path.join(path, "steamapps\\common\\dota 2 beta\\content\\dota_minify")

    ## base game
    dota2_executable = os.path.join(path, "steamapps\\common\\dota 2 beta\\game\\bin\\win64\\dota2.exe")
    dota2_tools_executable = os.path.join(path, "steamapps\\common\\dota 2 beta\\game\\bin\\win64\\dota2cfg.exe")
    dota_core_pak01_path = os.path.join(path, "steamapps\\common\\dota 2 beta\\game\\core\\pak01_dir.vpk")
    dota_pak01_path = os.path.join(path, "steamapps\\common\\dota 2 beta\\game\\dota\\pak01_dir.vpk")
    dota_itembuilds_path = os.path.join(path, "steamapps\\common\\dota 2 beta\\game\\dota\\itembuilds")
    dota_map_path = os.path.join(path, "steamapps\\common\\dota 2 beta\\game\\dota\\maps\\dota.vpk")
    dota_resource_compiler_path = os.path.join(
        path, "steamapps\\common\\dota 2 beta\\game\\bin\\win64\\resourcecompiler.exe"
    )
    print(steam_dir)
    print(minify_dota_compile_input_path)
    print(minify_dota_compile_output_path)
    print(minify_dota_pak_output_path)
    print(minify_dota_maps_output_path)
    print(minify_dota_content_path)
    print(dota2_executable)
    print(dota2_tools_executable)
    print(dota_core_pak01_path)
    print(dota_pak01_path)
    print(dota_itembuilds_path)
    print(dota_map_path)
    print(dota_resource_compiler_path)
