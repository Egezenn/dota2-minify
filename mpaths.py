...
# dota2 paths
content_dir = os.path.join(  # resourcecompiler required dir
    steam_dir, "steamapps\\common\\dota 2 beta\\content\\dota_addons\\minify"
)
game_dir = os.path.join(  # compiled files from resourcefiles
...
dota_minify_content = os.path.join(steam_dir, "steamapps\\common\\dota 2 beta\\content\\dota_minify")  # required?
dota_minify = os.path.join(steam_dir, "steamapps\\common\\dota 2 beta\\game\\dota_minify")  # where the pak ends up
