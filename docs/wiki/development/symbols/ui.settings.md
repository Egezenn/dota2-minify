...
## `apply_preset(sender, app_data, user_data)`
...
## `handle_button_click(sender, app_data, user_data)`
...
## `refresh(sender, app_data, user_data)`
...
## `reset(sender, app_data, user_data)`
...
## `add_to_list(sender, app_data, user_data)`
...
## `remove_from_list(sender, app_data, user_data)`
...
## `snap_slider(sender, app_data, user_data)`
