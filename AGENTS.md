...
- **Package Manager**: `uv`
- **Execution Mode**: Headless CLI (`typer`)

## Core Directory Structure

- `Minify/`: The main application package.
  - `__main__.py`: The entry point for headless execution.
  ...
  - `core/`: Contains fundamental backend modules:
    ...
    - `output.py`: Agnostic communication interface between backend and CLI.
...
- `script.py`, `script_initial.py`, `script_after_decompile.py`, `script_after_recompile.py`, `script_after_patch.py`, `script_prelaunch.py`, `script_uninstall.py`, etc.
