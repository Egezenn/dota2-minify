<!-- LANG:EN -->
Lets you use Dota2ProTracker's hero grids. Merges the grids to your existing layouts.
...
<!-- LANG:CS -->
Umožňuje používat mřížky hrdinů z Dota2ProTracker. Slučuje mřížky s vašimi stávajícími rozvrženími.
...
<!-- LANG:EL -->
Σας επιτρέπει να χρησιμοποιείτε τα πλέγματα ηρώων του Dota2ProTracker. Συγχωνεύει τα πλέγματα με τις υπάρχουσες διατάξεις σας.
...
<!-- LANG:ES -->
Te permite usar las cuadrículas de héroes de Dota2ProTracker. Combina las cuadrículas con tus diseños existentes.
...
<!-- LANG:FI -->
Voit käyttää Dota2ProTrackerin sankariruudukoita. Yhdistää ruudukot olemassa oleviin asetteluihisi.
...
<!-- LANG:FR -->
Permet d'utiliser les grilles de héros de Dota2ProTracker. Fusionne ces grilles avec vos configurations existantes.
...
<!-- LANG:HU -->
Lehetővé teszi a Dota2ProTracker hősrácsainak használatát. Egyesíti a rácsokat a meglévő elrendezéseiddel.
...
<!-- LANG:IT -->
Ti permette di usare le griglie degli eroi di Dota2ProTracker. Unisce le griglie ai tuoi layout esistenti.
...
<!-- LANG:PL -->
Umożliwia korzystanie z siatek bohaterów Dota2ProTracker. Łączy siatki z istniejącymi układami.
...
<!-- LANG:RO -->
Îți permite să utilizezi grilele de eroi din Dota2ProTracker. Îmbină grilele cu layout-urile existente.
...
<!-- LANG:RU -->
Позволяет использовать сетки героев из Dota2ProTracker. Объединяет сетки с вашими существующими макетами.
...
<!-- LANG:SV -->
Låter dig använda Dota2ProTrackers hjälte-rutnät. Sammanfogar rutnäten med dina befintliga layouter.
...
<!-- LANG:TR -->
Dota2ProTracker'ın kahraman ızgaralarını kullanmanıza olanak tanır. Izgaraları mevcut düzenlerinize entegre eder.
...
<!-- LANG:UK -->
Дозволяє використовувати сітки героїв Dota2ProTracker. Об'єднує сітки з вашими існуючими макетами.
