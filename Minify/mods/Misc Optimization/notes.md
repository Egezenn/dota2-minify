...
- Частици за атака на кула/снаряди/разрушения
- Частици за чучела
- Опростени илюзии
...
- Částice projektilů/zničení útočných věží
- Částice figurín
- Zjednodušené iluze
...
- Tårnangrebsprojektiler / ødelæggelsespartikler
- Dukkepartikler
- Forenklede illusioner
...
- Projektil-/Zerstörungspartikel von Turmangriffen
- Abbildpartikel
- Vereinfachte Illusionen
...
- Σωματίδια βλήματος επίθεσης / καταστροφής πύργου
- Σωματίδια ομοιώματος
- Απλοποιημένες ψευδαισθήσεις
...
- Tornihyökkäysammukset / tuhohiukkaset
- Nukkehiukkaset
- Yksinkertaistetut illuusiot
...
- Suppression des particules de projectiles/de destruction des tours
- Suppression des particules d'effigie
- Suppression des illusions simplifiées
...
- Torony támadási lövedék / romboló részecskék
- Bábu részecskék
- Egyszerűsített illúziók
...
- Proiettili di attacco/distruzione delle torri
- Particelle di effigie
- Illusioni semplificate
...
- Deeltjes van torenaanvalsprojectielen/vernietiging
- Deeltjes van beelden
- Vereenvoudigde illusies
...
- Tårnangrepsprosjektiler / ødeleggelsespartikler
- Dukkepartikler
...
- Cząsteczki pocisków/destrukcji atakujących wieżę
- Cząsteczki podobizny
- Uproszczone iluzje
...
- Partículas de projéteis/destruição de torres
- Partículas de efígies
- Ilusões simplificadas
...
- Proiectil de atac / particule de distrugere pentru turnuri
- Particule de efigie
- Iluzii simplificate
...
- Частицы снарядов/разрушений от атак башен
- Частицы от чучел
- Упрощенные иллюзии
...
- Projektiler/förstörelsepartiklar för tornattacker
- Partiklar av dofter
- Förenklade illusioner
...
- อนุภาคกระสุนโจมตี/การทำลายของหอคอย
- อนุภาคหุ่นจำลอง
- ภาพลวงตาแบบง่าย
...
- Hiệu ứng hạt của đạn tấn công/phá hủy tháp phòng thủ
- Hiệu ứng hạt của hình nộm
- Hiệu ứng ảo ảnh được đơn giản hóa
